...
def get_baseline_design_matrix(modeldir, sub):
    # get the path of the baseline design matrix for one sub
...
#%%
def compute_crossvalidated_r2(fmri_runs, dmtx, loglabel, logcsvwriter):
...
def do_single_subject(ROOTDIR, OUTDIR, subj):
    ...
    results = compute_crossvalidated_r2(fmri_runs, dmtx, loglabel, logcsvwriter)
